...
container.bind<IGetThemePanelUseCase>(TYPES.GetThemePanelUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new GetThemePanelUseCase(audienceRepository)
}).inSingletonScope()

container.bind<IRefreshThemePanelUseCase>(TYPES.RefreshThemePanelUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new RefreshThemePanelUseCase(audienceRepository)
}).inSingletonScope()
...
container.bind<IGetContentSuggestionsUseCase>(TYPES.GetContentSuggestionsUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new GetContentSuggestionsUseCase(audienceRepository)
}).inSingletonScope()

container.bind<IRefreshContentSuggestionsUseCase>(TYPES.RefreshContentSuggestionsUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new RefreshContentSuggestionsUseCase(audienceRepository)
}).inSingletonScope()

container.bind<IGetContentSuggestionDetailUseCase>(TYPES.GetContentSuggestionDetailUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new GetContentSuggestionDetailUseCase(audienceRepository)
}).inSingletonScope()

container.bind<ISendContentSuggestionFeedbackUseCase>(TYPES.SendContentSuggestionFeedbackUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new SendContentSuggestionFeedbackUseCase(audienceRepository)
}).inSingletonScope()

container.bind<ITriggerContentProductionUseCase>(TYPES.TriggerContentProductionUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new TriggerContentProductionUseCase(audienceRepository)
}).inSingletonScope()

container.bind<IGetContentDraftsUseCase>(TYPES.GetContentDraftsUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new GetContentDraftsUseCase(audienceRepository)
}).inSingletonScope()

container.bind<IGetContentDraftDetailUseCase>(TYPES.GetContentDraftDetailUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new GetContentDraftDetailUseCase(audienceRepository)
}).inSingletonScope()

container.bind<IAskIntentUseCase>(TYPES.AskIntentUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new AskIntentUseCase(audienceRepository)
}).inSingletonScope()

container.bind<IStreamTopicChatMessageUseCase>(TYPES.StreamTopicChatMessageUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new StreamTopicChatMessageUseCase(audienceRepository)
}).inSingletonScope()
...
container.bind<ISemanticSearchUseCase>(TYPES.SemanticSearchUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new SemanticSearchUseCase(audienceRepository)
}).inSingletonScope()

container.bind<IGetYouTubeValidationUseCase>(TYPES.GetYouTubeValidationUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new GetYouTubeValidationUseCase(audienceRepository)
}).inSingletonScope()

container.bind<ITriggerYouTubeValidationUseCase>(TYPES.TriggerYouTubeValidationUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new TriggerYouTubeValidationUseCase(audienceRepository)
}).inSingletonScope()

container.bind<IGetYouTubeValidationVideosUseCase>(TYPES.GetYouTubeValidationVideosUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new GetYouTubeValidationVideosUseCase(audienceRepository)
}).inSingletonScope()

container.bind<IGetProductIntelligenceUseCase>(TYPES.GetProductIntelligenceUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new GetProductIntelligenceUseCase(audienceRepository)
}).inSingletonScope()

container.bind<ITriggerProductIntelligenceUseCase>(TYPES.TriggerProductIntelligenceUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new TriggerProductIntelligenceUseCase(audienceRepository)
}).inSingletonScope()

container.bind<IGetProductDetailUseCase>(TYPES.GetProductDetailUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new GetProductDetailUseCase(audienceRepository)
}).inSingletonScope()

container.bind<IGetProductOpportunitiesUseCase>(TYPES.GetProductOpportunitiesUseCase).toDynamicValue(() => {
  const audienceRepository = container.get<IAudienceRepository>(TYPES.AudienceRepository)
  return new GetProductOpportunitiesUseCase(audienceRepository)
}).inSingletonScope()
