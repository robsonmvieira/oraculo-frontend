...
function RadarChart({
  ...
  useEffect(() => {
    ...
    // Labels
    const labels = propLabels ?? ['Age', 'Reach', 'Size', 'Activity', 'Growth']
    ...
    <div className="flex flex-col items-center">
      ...
      <div className="flex items-center gap-4 mt-2 text-xs">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-gray-500 dark:text-zinc-400">{redditAvgLabel ?? 'Reddit Avg'}</span>
        </div>
        <div className="flex items-center gap-1.5">
    ...
    >
      ...
      <div className="space-y-3 mb-6">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="text-gray-600 dark:text-zinc-300">{stats.type === 'Curated Audience' ? t('detail.curatedAudience') : t('detail.autoGenerated')}</span>
        </div>
        <div className="flex items-center gap-2 text-sm">
          <span className="text-gray-500 dark:text-zinc-400">👥</span>
          <span className="text-gray-600 dark:text-zinc-300">
            {formatNumber(stats.totalMembers)} {t('about.members')}
          </span>
        </div>
        <div className="flex items-center gap-2 text-sm">
          <span className="text-gray-500 dark:text-zinc-400">📈</span>
          <span className="text-gray-600 dark:text-zinc-300">
            ...
            {stats.monthlyGrowth.toFixed(1)}{t('about.monthlyGrowth')}
          </span>
        </div>
      </div>
      ...
      <RadarChart
        ...
        labels={[t('about.age'), t('about.reach'), t('about.size'), t('about.activity'), t('about.growth')]}
        redditAvgLabel={t('about.redditAvg')}
      />
    </div>
  )
}
